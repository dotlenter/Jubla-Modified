                              ...
                              Container(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    if (state.productEdit.productUint8ListImg !=
                                            null &&
                                        _image == null) ...[
                                      ClipRRect(
                                        borderRadius: BorderRadius.circular(10),
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                Expanded(
                                                  child: Text(
                                                    state.editProductPrice <= 0
                                                        ? 'P${state.productEdit.productPrice}'
                                                        : 'P${state.editProductPrice}',
                                                    maxLines: 1,
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                onChanged: (value) => context.read<MainCubit>()
                                  ..onEditProductNameChanged(value),
                                validator: (val) =>
                                    state.editProductNameError.isNotEmpty
                                        ? state.editProductNameError
                                        : null,
                              ),
                            ),
                          ],
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                initialValue:
                                    '${state.productEdit.productPrice}',
                                decoration: InputDecoration(
                                  focusColor: Theme.of(context).accentColor,
                                  enabledBorder: const UnderlineInputBorder(
                                    borderSide: BorderSide(
                                ...
                                onChanged: (value) => context.read<MainCubit>()
                                  ..onEditProductPriceChanged(value),
                                validator: (val) =>
                                    state.editProductPriceError.isNotEmpty
                                        ? state.editProductPriceError
                                        : null,
                              ),
                            ),
                          ],
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                onChanged: (value) => context.read<MainCubit>()
                                  ..onEditProductCostChanged(value),
                                validator: (val) =>
                                    state.editProductCostError.isNotEmpty
                                        ? state.editProductCostError
                                        : null,
                              ),
                            ),
                          ],
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                initialValue: state
                                        ...
                                        null
                                    ? ''
                                    : '${state.productEdit.productDescription}',
                                decoration: InputDecoration(
                                  focusColor: Theme.of(context).accentColor,
                                  enabledBorder: const UnderlineInputBorder(
                                    borderSide: BorderSide(
                                ...
                                validator: (val) =>
                                    state.editProductDescriptionError.isNotEmpty
                                        ? state.editProductDescriptionError
                                        : null,
                              ),
                            ),
                          ],
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                initialValue:
                                    state.productEdit.productCode == null
                                        ? ''
                                        : '${state.productEdit.productCode}',
                                decoration: InputDecoration(
                                  focusColor: Theme.of(context).accentColor,
                                  enabledBorder: const UnderlineInputBorder(
                                    borderSide: BorderSide(
                                ...
                                validator: (val) =>
                                    state.editProductCodeError.isNotEmpty
                                        ? state.editProductCodeError
                                        : null,
                              ),
                            ),
                          ],
